...
class InvoiceComposer: NSObject {
    ...
    let senderInfo = "Mahender Reddy Test<br>123 Somewhere Str.<br>10000 - MyCity<br>MyCountry"
    
    let dueDate = ""
    
    let paymentMethod = "Paytm Transfer"
    
    let logoImageURL = "https://nanimahender.files.wordpress.com/2017/01/bmw_s_1000_r_2014-1920x1080.jpg?w=341"
